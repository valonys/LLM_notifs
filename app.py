...
from utils.performance_optimizer import performance_optimizer, performance_monitor, optimize_streamlit_layout
...
**ANALYSIS FRAMEWORK:**
1. **Critical Findings**: Any increase in the number of notifications that requires immediate attention
2. **Trend Analysis**: Evaluation of NCs (non-conformity) to NI (notification of integrity) ratio and their trends
3. **Recommendations**: Actionable iteration with EPT and Inspection Topside Offshore to address identified issues and improve reporting naming convention
...
**INDUSTRIAL CONTEXT:**
Focus on FPSO operations, offshore equipment reliability, maintenance schedules, and regulatory compliance requirements. Use technical terminology appropriately while ensuring clarity for both technical and management audiences.

**NAMING CONVENTION AUGMENTATION:**
When analyzing notifications, adhere to the Naming Convention:
  - Types: ICOA (Internal Coating), COA (External Coating), PASS (Passivation), REPL (Replacement without welding), WELD (Replacement by welding)
